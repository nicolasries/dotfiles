...
* Misc
#+BEGIN_SRC emacs-lisp
(defun nri/go-to-next () (let ((nri/org-context (car (org-element-context))))
  (cond (
(eq nri/org-context 'src-block) (org-babel-next-src-block)
(eq nri/org-context 'link) (org-next-link)

))))

  ;; (if (eq nri/org-context 'src-block) (message nri/org-context)))
#+END_SRC
